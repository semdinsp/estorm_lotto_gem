...
translations = {
    'la':{"title": u'ຕົວແທນຮັບສີນຄ້າ ', "prize":u"ລາງວັນ ","game":u"ເກມ ", "total":u"ຍອດລວມ","txid": u"ລະຫັດການເຄືອນໄຫວ ", "win": u"ຢັ້ງຢືນການນັບຜູ້ຖືກລາງວັນ ", "fail": u"ການນັບໃບຫວຍຜິດຜາດ"},
    'en': {"title":"Validation Receipt", "prize":"Prize ","game":"Game ", "total":"Total ", "txid": "Tx ID: ","win": "Win Count ","fail": "Failed Count "}
}
...
tms_printer.normal()
tms_printer.println("Contents:\n " + str(options['contents']))

module EstormLottoGem
  ...
  def self.scratch_logos
    build_array(['estormcrm','timorscratch','scratchlao','timortoto'])    
  end
...
["24","Weasel-Laku"],["25","Deer-Bibi_rusa"]]
  ...
  def self.upgrade_types
    build_array(['gems','system','sound','script','views','bundle','scratch'])
  end
  ...
  def self.district_manager_teams
    build_array(['unassigned','None','Cancio','Zeferino','Hermenio','Mgmt'])
  end
